<script lang="ts">
  ...
  import HygieneTab from './components/HygieneTab.svelte'
...
<div class="px-6 mx-auto max-w-7xl">
  ...
  <div class="rounded-md p-4 bg-white">
    ...
    <Header title="{$currentRegister.title}" course="{courses[$currentRegister.course]}" registerId="{$currentRegister.id}" activeTab="2" />
    <HygieneTab />
